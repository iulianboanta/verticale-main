...
import { verticalDespreContent, verticalDespreImages } from "@/lib/verticalDespreContent";
...
const beautyImages = { hero: heroImg, clienti: clientiImg, profesionisti: profesionistiImg, retea: reteaImg };
...
const DespreNoi = () => {
  ...
  const override = verticalDespreContent[vertical.key];
  const c = override ?? stored;
  const images = verticalDespreImages[vertical.key] ?? beautyImages;
